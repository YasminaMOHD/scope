                        ...
                        <div class="card mb-3">
                            <div class="card-header" id="heading-1">
                                <div class="row">
                                    ...
                                    <div class="col-6">
                                        @php
                                        $projectLeadNo = App\Models\Lead::where('project_id', $project->id)->count();
                                        @endphp
                            ...
                            <div id="project-{!!$project->id!!}" class="collapse" aria-labelledby="heading-{!!$project->id!!}" data-parent="#accordion">
                                @if ($projectLeadNo > 0)
                                            ...
                                            <tbody>
                                                @foreach ($project->campagine as $campagine)
                                                    <tr>
                                                        ...
                                                        @php
                                                         $leadNo = App\Models\Lead::where('campagine_id',$campagine->id)->count(); @endphp
                                                        <td>{!! $leadNo !!}</td>
                                                    </tr>
                                                @endforeach
                                            </tbody>
